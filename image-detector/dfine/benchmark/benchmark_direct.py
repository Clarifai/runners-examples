#!/usr/bin/env python3
"""Benchmark script for D-Fine object detection - Direct model calls (local unary-unary)."""
...
def run_benchmark():
    """Run benchmark with direct model calls."""
    print(f"=== D-Fine Object Detection Benchmark ===")
    print(f"Mode: LOCAL Unary-Unary (direct model calls)")
