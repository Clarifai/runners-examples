#!/usr/bin/env python3
"""Benchmark script for D-Fine object detection - Unary-Unary requests."""
...
def run_benchmark():
    """Run benchmark with unary-unary requests."""
    print(f"=== D-Fine Object Detection Benchmark ===")
    print(f"Mode: Unary-Unary (sequential requests)")
    print(f"Number of requests: {NUM_REQUESTS}")
    print(f"Image size: {IMAGE_SIZE[0]}x{IMAGE_SIZE[1]}")
    print(f"Model: {USER_ID}/{APP_ID}/{MODEL_ID}")
    ...
    try:
        ...
        print("Make sure the local runner is running!")
        return
